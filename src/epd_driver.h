...
/* Canvas */
#define EPD_CANVAS_ORIENTATION 270

#if EPD_CANVAS_ORIENTATION == 0 || EPD_CANVAS_ORIENTATION == 180
#define EPD_CANVAS_WIDTH EPD_WIDTH
#define EPD_CANVAS_HEIGHT EPD_HEIGHT

#elif EPD_CANVAS_ORIENTATION == 90 || EPD_CANVAS_ORIENTATION == 270
#define EPD_CANVAS_WIDTH EPD_HEIGHT
#define EPD_CANVAS_HEIGHT EPD_WIDTH

#else
#error "Invalid orientation for EPD_CANVAS_WIDTH and EPD_CANVAS_HEIGHT"
    ...
    // Canvas buffer re-arrange function
    void canvas_framebuffer_to_device_framebuffer(uint16_t orientation, uint8_t *source_buffer, int32_t source_width, int32_t source_height, uint8_t *dest_buffer, int32_t *dest_width, int32_t *dest_height);
